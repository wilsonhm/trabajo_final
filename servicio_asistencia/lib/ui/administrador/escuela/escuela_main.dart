...
import 'package:servicio_asistencia/ui/administrador/escuela/escuela_edit.dart';
import 'package:servicio_asistencia/ui/administrador/escuela/escuela_form.dart';
...
class MainEscuelaB extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
  return MultiBlocProvider(
        providers: [
          BlocProvider(create: (_)=>EscuelaBloc(EscuelaRepository())),
        ],
        child: MaterialApp(
...
void initState() {
  ...
  //api=Provider.of<PredictionApi>(context, listen: false).getPrediction();
    print("entro aqui");
    BlocProvider.of<EscuelaBloc>(context).add(ListarEscuelaEvent());
  }  
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: BlocBuilder<EscuelaBloc,EscuelaState>(
            builder:(context,state){
              if(state is EscuelaLoadedState){
                return _buildListView(state.escuelaList);
              }else{
                              ...
                              IconButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => EscuelaFormEdit(modelE: personax)),
                                    ).then(onGoBack);
                                  }),
                              IconButton(
                                  ...
                                  onPressed: () {
                                    showDialog(
                                      ...
                                      if (value.toString() == "Success") {
                                        print(personax.id);
                                        BlocProvider.of<EscuelaBloc>(context).add(DeleteEscuelaEvent(personax));
