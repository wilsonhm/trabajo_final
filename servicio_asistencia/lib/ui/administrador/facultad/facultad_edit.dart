...
class FacultadFormEdit extends StatefulWidget {
  FacultadModelo modelF;
    FacultadFormEdit({required this.modelF}):super();
  @override
  _FacultadFormEditState createState() => _FacultadFormEditState(modelF:modelF);
}

class _FacultadFormEditState extends State<FacultadFormEdit> {
    FacultadModelo modelF;
  _FacultadFormEditState({required this.modelF}):super();
  late int _id = 0;
