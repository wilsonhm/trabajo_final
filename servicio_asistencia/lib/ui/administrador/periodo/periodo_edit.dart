...
class PeriodoFormEdit extends StatefulWidget {
PeriodoModelo modelR;
PeriodoFormEdit({required this.modelR}):super();
  @override
  _PeriodoFormEditState createState() => _PeriodoFormEditState(modelR:modelR);
}

class _PeriodoFormEditState extends State<PeriodoFormEdit> {
   PeriodoModelo modelR;
  _PeriodoFormEditState({required this.modelR}):super();
  late int _id = 0;
  late String _nombre = "";
