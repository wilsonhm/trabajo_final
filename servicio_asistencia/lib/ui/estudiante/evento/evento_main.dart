...
class MainEventoR extends StatelessWidget {
  @override
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      PeriodoFormEdit(modelV: periodo),
                                ),
                              ).then(onGoBack);
                            },
                          ),
...
class EventoMainPeriodoF extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
      ...
      child: MaterialApp(
        ...
        themeMode: AppTheme.useLightMode ? ThemeMode.light : ThemeMode.dark,
        theme: AppTheme.themeData,
        home: EventoPeriodoUI(),
      ),
    );
  }
}

class EventoPeriodoUI extends StatefulWidget {
  @override
  _EventoPeriodoUIState createState() => _EventoPeriodoUIState();
}

class _EventoPeriodoUIState extends State<EventoPeriodoUI> {
  @override
  void initState() {
    super.initState();
    BlocProvider.of<PeriodoBloc>(context).add(ListarPeriodoEvent());
